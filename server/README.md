...
- Документація доступна по URL: [http://localhost:4000/api-docs](http://localhost:4000/api-docs)
...
- Через **Swagger UI** можна тестувати API безпосередньо з браузера або postman, надсилаючи запити і переглядаючи відповіді.
