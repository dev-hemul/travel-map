  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#F4EFFF] to-[#744ce9]/10 p-5 sm:p-6 md:p-8 lg:p-10 xl:p-12">
      ...
      >
        ...
        <Link
          to="/"
          className="inline-flex items-center justify-center gap-2 rounded-xl border border-indigo-200 px-4 py-3 text-base font-semibold text-[#744ce9] hover:bg-[#744ce9]/5 active:scale-[0.99] transition"
        >
        ...
        <button
          type="submit"
          className="w-full bg-[#744ce9] text-base sm:text-base md:text-lg lg:text-lg xl:text-xl text-white py-3 sm:py-2 md:py-3 lg:py-3 xl:py-4 rounded-xl font-semibold hover:bg-[#5d39b3] transition shadow cursor-pointer min-h-[48px]"
        >
        ...
        <div className="flex justify-center gap-4">
          <button
            ...
            type="button"
            className="flex items-center justify-center bg-white border border-gray-300 rounded-full shadow-md hover:shadow-xl transition-all duration-200 w-12 h-12 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-12 lg:h-12 xl:w-14 xl:h-14 cursor-pointer"
          ...
          <button
            ...
            className="relative rounded-full overflow-hidden bg-[#229ED9] shadow-md hover:shadow-xl hover:bg-[#1e8bc5] transition-all duration-200 w-12 h-12 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-12 lg:h-12 xl:w-14 xl:h-14 flex items-center justify-center cursor-pointer"
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/30 z-50 p-5 sm:p-6 md:p-8 lg:p-10 xl:p-12">
          <div className="bg-white p-6 sm:p-6 md:p-7 lg:p-8 xl:p-10 rounded-2xl shadow-lg w-full max-w-[340px] sm:max-w-[380px] md:max-w-[440px] lg:max-w-[500px] xl:max-w-[560px] flex flex-col gap-5 sm:gap-5 md:gap-6 lg:gap-7 xl:gap-8 relative">
            ...
            <form onSubmit={handleResetPassword} className="flex flex-col gap-4">
              ...
              <button
                type="submit"
                className="w-full bg-[#744ce9] text-white py-3 rounded-xl text-base md:text-lg lg:text-lg xl:text-xl font-semibold hover:bg-[#5d39b3] transition shadow cursor-pointer min-h-[48px]"
              >
                Надіслати
              </button>
            </form>
