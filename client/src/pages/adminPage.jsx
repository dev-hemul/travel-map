...
export default function AdminPage() {
  ...
  const fetchUsers = async ({ search = '', sortOption = 'newest' } = {}) => {
    try {
      setLoading(true);

      const res = await api.get('/admin/users', {
        params: { search, sortOption },
      });
  ...
  }, [debouncedSearch, sortOption, showUsers]);
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex gap-4 mb-4 flex-wrap">
        ...
        >
          {showUsers ? 'Сховати список' : loading ? 'Завантаження...' : 'Показати всіх користувачів'}
        </button>
        ...
        {showUsers && (
          <>
            ...
            >
              ...
              <option value="banned_first">Спочатку забанені</option>
          ...
          <table className="w-full border">
            <thead>
              <tr className="border-b bg-gray-100">
                ...
                <th className="p-2 text-left">Зареєстрований</th>
            ...
            <tbody>
              {users.map((u) => (
                <tr key={u._id} className="border-b">
                  ...
                  <td className="p-2">
                    <span className={u.isBanned ? 'text-red-600 font-semibold' : 'text-green-600 font-semibold'}>
