          ...
          <div className="space-y-6">
            {offer.events && offer.events.length > 0 ? (
              offer.events.map(event => (
                <div key={event.id} className="bg-white rounded-2xl border border-gray-200 p-6 hover:border-[#744ce9]/30 transition-colors">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="text-right">
                      <div className="text-2xl font-bold text-[#744ce9]">{event.price}</div>
                      <div className="text-sm text-gray-500 mt-1">{event.format}</div>
                    </div>
                  </div>
                  <motion.button
                    whileHover={{ scale: 1.02 }}
          ...
          <div className="space-y-6">
            {offer.reports && offer.reports.length > 0 ? (
              offer.reports.map(report => (
                <div key={report.id} className="bg-white rounded-2xl border border-gray-200 p-6 hover:border-[#744ce9]/30 transition-colors">
                  <div className="flex justify-between items-start mb-4">
                    <div>
              ...
              <div className="text-center py-12 bg-white rounded-2xl border border-gray-200">
                ...
                <p className="text-gray-500">Звіти з&apos;ься після проведення подій</p>
              </div>
            )}
          </div>
        );
                  ...
                  <div className="flex flex-col items-center text-center mb-6">
                    <div className="relative mb-4">
                      ...
                      <div className="absolute bottom-0 right-0 bg-white rounded-full p-2 shadow-md">
                        <div className="w-8 h-8 bg-gradient-to-r from-[#744ce9] to-[#8a6de8] rounded-full flex items-center justify-center">
                  ...
                  <div className="flex flex-wrap">
                    {[
                      ...
                      <button
                        ...
                        className={`flex items-center gap-2 px-6 py-4 font-medium text-sm sm:text-base border-b-2 transition-colors ${
                          activeTab === tab.id
