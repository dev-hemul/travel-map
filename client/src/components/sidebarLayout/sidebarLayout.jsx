  ...
  return (
    <div className="flex min-h-screen bg-[#F3F3F3]">
      ...
      >
        ...
        {/* Заголовок */}
        <motion.h1
          className={`font-bold mb-8 text-[#744ce9] whitespace-nowrap overflow-hidden h-[10%] 
            ${
              windowWidth < breakPoint768 && isSidebarOpen
        ...
        <motion.div
          className={`mb-8 whitespace-nowrap overflow-hidden 
            ${
              windowWidth < breakPoint768 && isSidebarOpen
                ? "text-center w-full text-xl"
                : ""
            }`}
          animate={{ opacity: isSidebarOpen ? 1 : 0 }}
          transition={{ duration: 0.2 }}
        >
          <h2 className="text-[#744ce9] h-10">Вітаємо Користувач!</h2>
        </motion.div>
