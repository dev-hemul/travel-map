          ...
          >
            <div className="relative bg-gradient-to-r from-blue-600 to-indigo-700 p-5 sm:p-6 pb-7 rounded-none md:rounded-t-2xl">
              ...
              <p className="text-blue-100 mt-1 text-base">
                Додайте інформацію про нову локацію8888
              </p>

              <div className="absolute -bottom-4 left-0 right-0 h-8 bg-white rounded-full hidden md:block"></div>
            </div>

            <form
              onSubmit={handleSubmit}
              className="p-5 pt-8 md:pt-3 h-[calc(100vh-140px)] md:h-auto md:max-h-[75vh] overflow-y-auto custom-scrollbar"
            >
